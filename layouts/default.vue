    ...
    <div class="flex h-screen">
      <aside class="flex flex-col p-3 bg-gray-100">
        ...
        <div class="flex-1 my-2">
          ...
          <nuxt-link class="menu-item" to="/vmess/">VMess URL editor</nuxt-link>
        </div>
...
Vue.prototype.showToast = (text, time = 2000) => {
  id += 1;
  const item = {
    id,
    text,
  ...
  if (time) setTimeout(dismiss, time);
  return dismiss;
};
